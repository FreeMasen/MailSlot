...
namespace MailSlot
{
    class RawMailSlot
    {
        ...
        {
            var ret = CreateMailslot(name, maxMessageSize, timeout, securityAttrs);
            if (ret.IsInvalid)
            {
        ...
        private static extern SafeMailslotHandle CreateMailslot(string mailslotName,
        ...
        [DllImport("kernel32.dll", CharSet = CharSet.Auto, SetLastError = true)]
        private static extern SafeMailslotHandle CreateFile(string fileName,
